...
```bash
uv run sim2real/rl_policy/tracking.py --robot_config ./config/robot/g1.yaml --policy_config checkpoints/lafan-aa/policy-tstz89tc-final.yaml
...
uv run sim2real/rl_policy/tracking.py \
  ...
  --policy_config checkpoints/lafan-aa/policy-tstz89tc-final.yaml \
  --motion_backend zmq \
