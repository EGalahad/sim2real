...
English version: [../../getting-started/teleop-x86-64.md](../../getting-started/teleop-x86-64.md)

`venv/teleop` 用来在 laptop / desktop 上跑 Pico / XR body tracking、realtime retarget 检查，以及 motion recording。
